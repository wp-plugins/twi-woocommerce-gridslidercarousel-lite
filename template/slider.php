...
?>
<div class="twi-woo-slider" data-autoplay="<?php echo $autoplay; ?>">
	<?php
	if($twi_woo_cats == null){
		...
		<div class="twi-panel twi-panel-box">
		    ...
		    <div class="twi-details">
			    <h3 class="twi_pro_title">
			     ...
			     <div class="twi-cart ui label green"><a href="<?php echo $product->add_to_cart_url(); ?>"><?php echo $product->add_to_cart_text(); ?></a></div>
		   </div>
		</div>
	</div>
	<?php 
