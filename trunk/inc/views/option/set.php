<div class="wrap">
	...
	<div id="vp-wrap" class="vp-wrap">
		...
		<div id="vp-copyright" class="vp-copyright">
			<p><?php printf(__('Thanks to use our plugin. You can visit our portfolio <strong><em><a href="http://codecanyon.net/user/twibd/portfolio" target="_blank">here on Codecanyon</a></em></strong>.', 'vp_textdomain'), VP_VERSION); ?></p>
		</div>
	</div>
</div>